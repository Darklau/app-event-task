...
const toggleVariants = cva(
    ...
    " disabled:opacity-50 data-[state=on]:bg-accent data-[state=on]:text-accent-foreground",
    {
        variants: {
            variant: {
                default: "bg-neutral-0 text-accent-main hover:bg-accent-green data-[state=on]:bg-accent-green data-[state=on]:hover:bg-opacity-80 data-[state=on]:text-neutral-0 hover:text-neutral-0",
                ghost:
