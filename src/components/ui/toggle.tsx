    ...
    ' disabled:opacity-50 data-[state=on]:bg-accent data-[state=on]:text-accent-foreground',
  {
    variants: {
      variant: {
        ...
        ghost:
          '  hover:text-neutral-0 text-neutral-700 bg-transparent hover:bg-accent-green data-[state=on]:hover:bg-opacity-80  data-[state=on]:text-neutral-0 data-[state=on]:bg-accent-green text-accent-main',
      },
      size: {
        default: 'h-10 px-3',
        sm: 'h-9 px-2.5',
